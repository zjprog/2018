...
### 1, 2, 3, 4. Wyszukujemy w kodzie fragmenty _WTF_
...
### 5, 6, 7. Narzędzia projektowania: Zasady i Wzorce

Dokładniej: podstawowe zasasdy i wzorce projektowe.
Wzorcom projektowym poświęcony jest inny wykład.
...
### 13, 14, 15. Prezentacje projektow na wykładach.
