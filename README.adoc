...
Do 17.01 jestem na zwolnieniu lekarskim, ale będzie zastępstwo. Będzie można
przedstawić swój projekt na wykładzie albo na laboratoriach 

* **Stacjonarne**: egzaminy z 9.01 i 16.01 odbędą się na środowych laboratoriach 22.01;
  będzie można też przedstawić swój projekt na wykładzie.
* **Niestacjonarne**: egzamin z soboty 11.01 zostanie przeniesiony na niedzielne 
  laboratoria 19.01; będzie można przedstawić swoj projekt na wykładzie 11.01.
