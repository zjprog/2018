...
### 5–7. Narzędzia projektowania – Podstawow Zasady

NOTE: Wzorcom projektowym poświęcony jest inny wykład.

* https://github.com/emilybache/GildedRose-Refactoring-Kata[Gilded Rose Refactoring Kata]; zob. też http://iamnotmyself.com/2011/02/13/refactor-this-the-gilded-rose-kata/[Refactor This: The Gilded Rose Kata].
...
Prześledzić jak zmieniał się kod wybranej klasy w czasie. Wykorzystać w tym celu polecenie _git_
(_git --log_).
